-- Return inserted snip id from record_image_snip_and_check_limit for source-line markers.
-- Run after supabase-snip-history-image-only.sql (and optionally after supabase-snip-history-text-storage.sql).
